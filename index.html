...
fwrite($logvisiteur, "le ".date("d-m-Y")." - ".date("H:i:s")." ".$_SERVER['HTTP_USER_AGENT']."<br>Utilisateur : ".$majUsersay."<br> Bot : ".$reponsebotcomplet."<br>(d&eacute;tect&eacute; ligne ".$numlignelog." : ".$coup[0]." ".$correction.")<br>".$_POST['vartemp']." ".round($temps_fin - $temps_debut, 4).'s'."<br><br>");
 fclose($logvisiteur); 
//print "<br>Ligne de reponse : ".$lignemaj."<br>";
print "<br><br>Utilisateur : ".$majUsersay;
print "<br>Bot : ". $reponsebotcomplet;
}




print "<form method=\"POST\" action=\"chatterbot23.php\" id=\"form_parler\">";
...
//print "<INPUT NAME=\"usersay\" autocomplete=\"off\" id=\"input\" size=60%\"><INPUT NAME=\"sauveinput\" id=\"sauveinput\" ><INPUT NAME=\"var\" value=\"".$_POST['var']."\" id=\"var\" TYPE=\"HIDDEN\" ><INPUT NAME=\"vartemp\" value=\"".$_POST['vartemp']."\" id=\"vartemp\" TYPE=\"HIDDEN\" ><INPUT NAME=\"cerveau\" value=\"".$_POST['cerveau']."\" id=\"cerveau\" TYPE=\"HIDDEN\" ><INPUT NAME=\"vraiesvars\" value=\"".$_POST['vraiesvars']."\" id=\"vraiesvars\" TYPE=\"HIDDEN\" ><INPUT NAME=\"nom\" value=\"".$_POST['nom']."\" id=\"nom\" TYPE=\"HIDDEN\" ><INPUT NAME=\"noreut\" value=\"".$_POST['noreut']."\" id=\"noreut\" TYPE=\"HIDDEN\" ><INPUT NAME=\"vraiesvars\" value=\"".$_POST['vraiesvars']."\" id=\"vraiesvars\"><INPUT NAME=\"rappel\" value=\"".$_POST['rappel']."\" id=\"rappel\" ><INPUT NAME=\"autorefresh\" id=\"autorefresh\" value=\"FALSE\"><input type=submit  value=\"Parler\">";
echo '<br><br>Instructions :<br>Utilisez le tutoiement. Tapez votre texte dans le cadre blanc ci-dessus, par exemple "bonjour" et pressez "entr&eacute;e" ou cliquez sur parler.</bR>';
echo"<b><br>Version Alpha.<br><font color=\"#C0000\"> BIG BROTHER WARNING : </font>Toutes les conversations seront <a href=\"logs/logs.php\">stock&eacute;es</a> et analys&eacute;es amoureusement.</b><br>";
if (file_exists("AR.txt")) {
    echo"<br>Derni&egrave;re modification du cerveau principal : " . date ("d/m/Y H:i:s.", filemtime("AR.txt"));
	echo"<br>Derni&egrave;re modification du fichier php : " . date ("d/m/Y H:i:s.", filemtime("chatterbot23.php"));
	echo"<br>Test sans cookies.<br>";

}

?>
<br><hr>
Contact : trotter.poulpe (chez gmail.com) - <a href="http://chatterbots.fr/forum/">T&eacute;l&eacute;chargement disponible sur le forum</a> - <a href="http://chatterbots.fr/chatterbots.htm">Annuaire de chatterbots</a>
